...
static void ScreenFiltersMenu_UpdateEntries(void)
{
    ...
    {
        screenFiltersMenu.items[10].title = "[Recomend. IPS] Mejora colores de pantalla sup.";
        screenFiltersMenu.items[10].method = &ScreenFiltersMenu_SetTopScreenSrgbColorCurve;
    }
    else
    {
        screenFiltersMenu.items[10].title = "Restaurar curva de colores de pantalla sup.";
    ...
    {
        screenFiltersMenu.items[11].title = "[Recomend. IPS] Mejora colores de pantalla inf.";
        screenFiltersMenu.items[11].method = &ScreenFiltersMenu_SetBottomScreenSrgbColorCurve;
    }
    else
    {
        screenFiltersMenu.items[11].title = "Restaurar curva de colores de pantalla inf.";
...
Menu screenFiltersMenu = {
    "Menu de filtros de pantalla",
    {
        ...
        { "[Recomend. IPS] Mejora colores de pantalla sup.", METHOD, .method = &ScreenFiltersMenu_SetTopScreenSrgbColorCurve },
        { "[Recomend. IPS] Mejora colores de pantalla inf.", METHOD, .method = &ScreenFiltersMenu_SetTopScreenSrgbColorCurve },
